...
namespace AngularApp.API.Controllers
{
    ...
    public class QuoteController : ApiController
    {
        ...
        /// <returns>
        /// A quote result, containing information about fees, repayables and interest
        /// </returns>
        /// <remarks>
        ...
        /// <returns>
        /// The quote whose GUID matches the GUID given to the function. If the Quote does not
        /// exist then it will return a 500 error
        /// </returns>
        /// <remarks>
        ...
        /// <returns>
        /// A 200 response if the procedure succeeds, else there will be an exception
        /// </returns>
        [HttpGet]
        ...
        /// <returns>
        /// A JObject representation of a row of the table
        /// </returns>
        /// <remarks>
